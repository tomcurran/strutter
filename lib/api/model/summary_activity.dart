...
class SummaryActivity {
  ...
  static List<SummaryActivity> listFromJson(List<dynamic> json) {
    return json == null ? List<SummaryActivity>() : json.map((value) => SummaryActivity.fromJson(value)).toList();
  }

  static Map<String, SummaryActivity> mapFromJson(Map<String, dynamic> json) {
    var map = Map<String, SummaryActivity>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = SummaryActivity.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of SummaryActivity-objects as value to a dart map
  static Map<String, List<SummaryActivity>> mapListFromJson(Map<String, dynamic> json) {
    var map = Map<String, List<SummaryActivity>>();
     if (json != null && json.isNotEmpty) {
       json.forEach((String key, dynamic value) {
         map[key] = SummaryActivity.listFromJson(value);
       });
     }
     return map;
  }
